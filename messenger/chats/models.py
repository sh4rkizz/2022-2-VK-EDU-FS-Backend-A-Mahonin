...
class Chat(Model):
    ...
    users: QuerySet = ManyToManyField(User, verbose_name='chat_users')
    ...
    def __str__(self):
        ...
        # favourites analog from TG and VK ?
...
class Message(Model):
    ...
    def __str__(self):
        return f'Author: {self.author}; Message: {self.content}; Sent at {self.time}'
